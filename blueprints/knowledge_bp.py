...
def add_kb_entry_endpoint(req: func.HttpRequest) -> func.HttpResponse:
    ...
    return json_response({"success": True, "added": added, "entry_count": len(kb.entries)}, status_code=201)
...
def import_kb_endpoint(req: func.HttpRequest) -> func.HttpResponse:
    ...
    return json_response({"success": True, "added": result["added"], "total": result["total"]})
